...
@implementation RNTModalHostView
{
  __weak RCTBridge *_bridge;
  BOOL _isPresented;
  RNTModalHostViewController *_modalViewController;
...
- (instancetype)initWithBridge:(RCTBridge *)bridge
{
  if ((self = [super initWithFrame:CGRectZero])) {
    _bridge = bridge;
    _modalViewController = [RNTModalHostViewController new];
    ...
    // Add callback to handle dismiss cleanup on disappear
    _modalViewController.dismissModal = ^() {
